...
{
    std::cout << "Le constructeur a ete appeler" << std::endl;
...
ClapTrap::ClapTrap(const ClapTrap &copie):_Name(copie._Name), _Hitpoints(copie._Hitpoints), _Energy_points(copie._Energy_points), _Attack_damage(copie._Attack_damage)
{
    ...
    std::cout << "Le constructeur par copie appeler" << std::endl;
    std::cout << "Name " << this->_Name << std::endl;
    std::cout << "Hitpoints " << this->_Hitpoints << std::endl;
    std::cout << "Energy points " << this->_Energy_points << std::endl;
    std::cout << "Attack damage " << this->_Attack_damage << std::endl;
...
{
    std::cout << "Le destructeur a ete appeler" << std::endl;
    return ;
}

void    ClapTrap::attack(std::string const &target)
{
    std::cout << this->_Name << " attaque " << target << std::endl;
    return ;
}

void    ClapTrap::takeDamage(unsigned int amount)
{
    std::cout << this->_Name << " a pris " << amount << " de domage:: votre vie a baisser" << std::endl;
    return ;
}

void    ClapTrap::beRepaired(unsigned int amount)
{
    std::cout << this->_Name << " va avoir " << amount << " de reparation:: votre vie a monter" << std::endl;
    return ;
}