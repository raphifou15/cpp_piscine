...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/08 16:09:26 by rkhelif           #+#    #+#             */
/*   Updated: 2021/12/08 16:09:34 by rkhelif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool bsp(Point const A, Point const B, Point const C, Point const P)
{
    ...
    if ((A.get_y() == B.get_y() && A.get_x() == B.get_x()) || (A.get_y() == C.get_y() && A.get_x() == C.get_x()) || (B.get_y() == C.get_y() && B.get_x() == C.get_x()))
    {
        std::cout << "les trois points doivent etre distinct pour faire un triangle" << std::endl;
        return (false);
    }
    if (A.get_y().toFloat() <= 0.1f && B.get_y().toFloat() <= 0.1f && C.get_y().toFloat() <= 0.1f)
    {
        std::cout << "Les donner sont trop proches de zero et causeront une boucle infinnie" << std::endl;
        return (false);
    }
    if (S1.toFloat() <= 0.1f)
         return (bsp(A, C, B, P));
