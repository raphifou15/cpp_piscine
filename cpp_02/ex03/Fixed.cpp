...
bool    Fixed::operator>(const Fixed &i) const{ return(this->_value > i._value);}
bool    Fixed::operator<(const Fixed &i) const{ return(this->_value < i._value);}
bool    Fixed::operator>=(const Fixed &i) const{ return(this->_value >= i._value);}
bool    Fixed::operator<=(const Fixed &i) const{ return(this->_value <= i._value);}
bool    Fixed::operator==(const Fixed &i) const{ return(this->_value == i._value);}
...
{
    float   lala = (this->toFloat() + i.toFloat());
    return (Fixed(lala));
}
...
Fixed   Fixed::operator++(int)
{
    ...
    ++(*this);
    return (Lala);
    // Attention, il ne faut pas que la version postfixée renvoie l'objet this par référence.
}
